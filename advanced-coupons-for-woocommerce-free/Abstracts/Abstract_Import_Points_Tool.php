...
abstract class Abstract_Import_Points_Tool {
    ...
    */
    ...
    public function import_points_for_customer( $user_id ) {
        ...
        $store_credit_entry->set_prop( 'action', 'imported_points' );
        $store_credit_entry->set_prop( 'amount', (float) wc_format_decimal( $total_points - $imported_points ) );
        ...
        update_user_meta( $user_id, $this->imported_points_meta_key, $imported_points + $store_credit_entry->get_prop( 'amount', true ) );
    ...
    /**
     * Get users with points based on the 3rd party plugin database table.
     *
     * @since 4.6.7
     * @access protected
     *
