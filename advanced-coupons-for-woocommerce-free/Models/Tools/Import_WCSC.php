...
use ACFWF\Abstracts\Abstract_Import_Points_Tool;
 ...
 * @since 4.6.7
 */
class Import_WCSC extends Abstract_Import_Points_Tool {

    const PLUGIN_ID   = 'wcsc';
    const PLUGIN_NAME = 'WooCommerce Smart Coupons';
    ...
    */
    ...
    public function __construct() {
        $this->_data = array(
            ...
            'imported_points_meta_key' => 'acfw_imported_points_from_wcsc',
            'plugin_basename'          => 'woocommerce-smart-coupons/woocommerce-smart-coupons.php',
        );
    }

    /**
     * Get users with points based on the WCSC database table.
     *
     * @since 4.6.7
     * @access protected
     *
    ...
    /**
     * Get the customer's total points for WCSC plugin.
     *
     * @since 4.6.7
     * @access protected
     *
